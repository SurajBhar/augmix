#Code for cifar-10-p Evaluation
import numpy as np
import os
import argparse
import time
...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='/work/ws-tmp/g051176-aumisb/augmix/Evaluation_folder', help='Folder to save checkpoints.')
#parser.add_argument('--load', '-l', type=str, default='/work/ws-tmp/g051176-aumisb/augmix/final_adam_hy_exp/h_convnext_pt/', help='Checkpoint path to resume / test.')
parser.add_argument(
    '--resume',
    '-r',
    type=str,
    default='/work/ws-tmp/g051176-aumisb/augmix/saved_models_sgd_lambdalr/resnet18_pt/',
